...
const Auth = () => {
  const { signInWithEmail, signUpWithEmail, signInWithGoogle, loading: authLoading, user } = useAuth();
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.success('Account created! Welcome to EduForce AI.');
      navigate('/dashboard');
    }
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold text-gradient">EduForce AI</span>
        </div>
